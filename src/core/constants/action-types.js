...
//
export const GET_CHART_ARTISTS_LOADING = "GET_CHART_ARTISTS_LOADING";
export const GET_CHART_ARTISTS_SUCCESS = "GET_CHART_ARTISTS_SUCCESS";
export const GET_CHART_ARTISTS_ERROR = "GET_CHART_ARTISTS_ERROR";
//
...
//
export const ADD_FOLLOWER_ALBUM = "ADD_FOLLOWER_ALBUM";
export const REMOVE_FOLLOWER_ALBUM = "REMOVE_FOLLOWER_ALBUM";
//
